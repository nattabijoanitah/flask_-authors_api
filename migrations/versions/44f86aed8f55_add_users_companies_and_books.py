"""add users companies and books

Revision ID: 44f86aed8f55
Revises: 
Create Date: 2026-05-01 00:32:14.916023
...
def upgrade():
    ...
    sa.Column('biography', sa.Text(length=500), nullable=False),
